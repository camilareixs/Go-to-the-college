...
function formatarTempo(tempo) {
    const tempoRestante = 1140 - tempo;
...
function exibirCronometro() {
    ...
    const tempoRestante = 1140 - tempoDecorrido;
    ...
    // Exibir o texto
    const textoTempo = `Tempo: ${formatarTempo(tempoDecorrido)}`;
    const textoX = 40;
    const textoY = 35;
    ...
    const barraProgressoPreenchimento = tempoRestante / 1140;
